...
:: 项目资源目录
set RESOURCE_DIR=%ROOT_DIR%\client\magiccarddeluxe\Resources
...
%TOOL_DIR%\I18NConv.exe --extract -i %LOCALIZATION_ROOT_DIR%\i18n.xml -l en_us -l zh_tw -p EXTRA_FULL -k %TEMP_DIR%\tutorial.xml -o %TEMP_DIR%\output.xml
