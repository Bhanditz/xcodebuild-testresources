...
opt:
    ...
    fast_debug          debug, but skip generating lots of resources
...
echo "KIM 161103 - 01 done include shell variables"
...
echo "KIM 161103 - 02 done include custom file"
...
echo "KIM 161103 - 03 done include version and last version:"
echo "KIM 161103 - 03a ENGINE_VER_MAJOR $ENGINE_VER_MAJOR"
echo "KIM 161103 - 03b ENGINE_VER_MINOR $ENGINE_VER_MINOR"
echo "KIM 161103 - 03c ENGINE_VER_PATCH $ENGINE_VER_PATCH"
echo "KIM 161103 - 03d CASINO_VER_MAJOR $CASINO_VER_MAJOR"
echo "KIM 161103 - 03e CASINO_VER_MINOR $CASINO_VER_MINOR"
echo "KIM 161103 - 03f CASINO_VER_PATCH $CASINO_VER_PATCH"
echo "KIM 161103 - 03g ENGINE_VER $ENGINE_VER"
echo "KIM 161103 - 03h CASINO_VER $CASINO_VER"
echo "KIM 161103 - 03i BUILD_VERSION $BUILD_VERSION"
echo "KIM 161103 - 03j HOST_NAME $HOST_NAME"
...
echo "KIM 161103 - 04 about to build common"
echo "KIM 161103 - 04a BASH_SOURCE_0 = ${BASH_SOURCE[0]}"
echo "KIM 161103 - 04b BASH_SOURCE_0 = ${BASH_SOURCE[0]}"
echo "KIM 161103 - 04c BASH_SOURCE_ALL = ${BASH_SOURCE[@]}"
...
echo "KIM 161103 - 05 DIR => $DIR"
echo "KIM 161103 - 05a CASINO_VER => $CASINO_VER"
echo "KIM 161103 - 05b PWD => $PWD"

cd $DIR

if [ -d "$DIR/$CASINO_VER" ]; then
    echo "copy version files..."
	cp -f $DIR/$CASINO_VER/*.* ./
fi

echo "KIM 161103 - 06 DIR => $DIR"
echo "KIM 161103 - 06a CASINO_VER_PATCH => $CASINO_VER_PATCH"
echo "KIM 161103 - 06b PWD => $PWD"
...
echo "KIM 161103 - 07 OPT_BUILD_PROTOCOL => $OPT_BUILD_PROTOCOL"
...
echo "KIM 161103 - 08 about to syn_res_from_art.sh"
...
echo "KIM 161103 - 09 OPT_GEN_LOCALIZATION => $OPT_GEN_LOCALIZATION"
...
echo "KIM 161103 - 10 about to syn_data_from_res.sh"
...
echo "KIM 161103 - 11 about to syn_cdn_from_data.sh"
...
echo "KIM 161103 - 12 about to syn_asset_from_data.sh"
...
SVN_NUMBER=$(git log --format="%h" -n 1)
echo "SVN_NUMBER = $SVN_NUMBER"

# get now date
NOW_DATE=$(date "+%m%d_%H%M")
echo "NOW_DATE = $NOW_DATE"

echo "KIM 161103 - 13 DIR => $DIR"
echo "KIM 161103 - 13b OPT_UPDATE_CONFIG => $OPT_UPDATE_CONFIG"
...
echo "KIM 161103 - 14 platform specific build"
echo "KIM 161103 - 14b PLATfORM => $PLATFORM"

# platform specific build
if [ "$PLATFORM" == "android" ]; then

echo "KIM 161103 - 15 about to copy app icons"
echo "KIM 161103 - 15b cygpath => $cygpath"
echo "KIM 161103 - 15c ART_ROOT => $ART_ROOT"
echo "KIM 161103 - 15d APP_PLATFORM_ROOT => $APP_PLATFORM_ROOT"
echo "KIM 161103 - 15d OPT_BUILD_JNI => $OPT_BUILD_JNI"
    ...
    if [ "$OPT_PACK_APK" == "true" ]; then
        ...
        if [ "$?" = "0" ]; then
			if [ "$OPT_MAKE_SYMBOL" = "true" ]; then
				...
				cd $DIR
				cmd /c make_symbol_file.bat ../symbol_backup "${LANGUAGE}_${NOW_DATE}_${SVN_NUMBER}" "android"
			else
        ...
        if [ "$?" = "0" ]; then
            if [ "$OPT_UPLOAD_APK" = "true" ]; then
                APK_NAME="casino_${LANGUAGE}_${BUILD_VERSION}_${CASINO_VER_MAJOR}.${CASINO_VER_MINOR}.${CASINO_VER_PATCH}.${SVN_NUMBER}_${NOW_DATE}_${TEXTURE_COMPRESS_FMT}"
        ...
        echo "skip pack caniso_${LANGUAGE}_${BUILD_VERSION}_${SVN_NUMBER}_${NOW_DATE}.apk"
    fi
